...
#
# TCL_DIR must be set to the installation directory of Tcl8.2
#
...
LIBS = $(TCL_DIR)\lib\tcl82.lib libcmt.lib kernel32.lib user32.lib \
	$(CURSES_LIB)

DLLLIBS = $(TCL_DIR)\lib\tcl82.lib msvcrt.lib kernel32.lib user32.lib \
	$(CURSES_LIB)
...
cwsh.exe: winMain.obj cwsh.res ck82.dll
	set LIB=$(MSVC)\lib
	$(LN) $(LFLAGS) winMain.obj cwsh.res -out:$@ $(DLLLIBS) ck82.lib
